...
export default function GrantFinder() {
  ...
  const [grantDeadlines, setGrantDeadlines] = useState<{ [id: string]: string }>({});
  ...
  useEffect(() => {
    ...
    grants.forEach(grant => {
      deadlines[grant.id] = new Date(grant.deadline).toLocaleDateString();
    });
    setGrantDeadlines(deadlines);
  }, [grants]);
            ...
            <div key={grant.id} style={{
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                      ⏰ Deadline: {grantDeadlines[grant.id] || 'Loading...'}
                    </span>
                  </div>
                </div>
